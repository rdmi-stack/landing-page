...
const INTENT_COPY: Record<string, { headlines: string[]; descriptions: string[] }> = {
  ...
  "ai-consulting-company": {
    headlines: [
      ...
      "Roadmap in Weeks, Not Slides",
      "Consultants Who Also Build",
      "We Ship, Not Just Advise",
      "Senior AI Consultant, Day One",
      "Cut Through the AI Hype",
      "Start With One Use Case",
      "Prove It Before You Scale",
      "Strategy and Code Are Yours",
      "GenAI, Agents, Automation",
      "Talk to an AI Consultant",
      "Honest, Feasible AI Plan",
      "No 100-Slide AI Deck",
    ],
    descriptions: [
      "AI consulting company that finds where AI actually pays off, then builds the first use case.",
      "Free AI opportunity assessment. A prioritised roadmap in weeks - honest, not a 100-slide deck.",
      "Consultants who also ship production AI: GenAI, LLMs, agents and automation on your data.",
      "You own the strategy, prompts and code. Senior consultant on the first call, no lock-in.",
    ],
  },
  "ai-chatbot-development": {
    headlines: [
      "Chatbot on Your Own Content",
      "Answers, Not Hallucinations",
      "See a Demo on Your Content",
      "Live on Web and WhatsApp",
      "Qualifies and Logs Leads",
      "Hands Off to a Human",
      "RAG-Grounded AI Chatbot",
      "24/7 Support and Sales Bot",
      "Custom, Not a Plugin",
      "Prompts and Code Are Yours",
      "Talk to a Chatbot Engineer",
      "Knowledge-Base Chatbot",
      "Built for Support and Leads",
      "No Per-Message Lock-In",
    ],
    descriptions: [
      "AI chatbot development company building bots that answer from your content, not guesses.",
      "Custom support and sales chatbots, RAG-grounded, live on web and WhatsApp with human handoff.",
      "See a working demo on your own content before you pay. Captures and qualifies leads to your CRM.",
      "You own the prompts and source code. No per-message reseller markup, no lock-in.",
    ],
  },
};
