  ...
  },
  {
    ...
    hero: {
      ...
      trustPoints: [
        ...
        "One logistics client eliminated 20+ hours/week of manual work",
    ...
    services: [
      ...
      },
      {
        ...
        description: "Invoice processing, lead scoring, content generation, email triage, report building — all on autopilot. n8n + custom orchestration replaces the spreadsheet-email-meeting loop your team wastes 20+ hours/week on. One client eliminated the equivalent of 8 full-time operational roles.",
    ...
    uspHeadlines: {
      ...
      cost: "An AI chatbot replaces 2 support staff. A RAG system replaces 3 research analysts. The ROI math is brutal — in your favor. Senior engineers, no sub-contracting.",
    ...
    faq: [
      ...
      { q: "How long until we see ROI?", a: "60-90 days for most deployments. A chatbot replacing 2 support staff typically pays back in under 12 months. A workflow agent saving 20 hrs/week pays back in 6 months. We model ROI before we write code." },
      ...
      { q: "How do we get started?", a: "Step 1: Fill the form (60 seconds). Step 2: Senior AI engineer calls within 2 hours. Step 3: 2-week paid discovery sprint with working prototype. Step 4: Approve and we build. Don't love the prototype? Walk away." },
    ],
    ctaSection: {
