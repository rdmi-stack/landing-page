...
export const keywordGroups: KeywordGroup[] = [
  ...
  },
  {
    ...
    ctaSection: {
      ...
      subtitle: "Talk direct to a senior web developer in 2 hours — not a salesperson. AI-powered custom website with built-in chatbot, SEO, and analytics. Walk away any month.",
  ...
  },
  {
    ...
    ctaSection: {
      ...
      subtitle: "Talk direct to a senior AI developer in 2 hours — not a salesperson. NDA signed same day. Working prototype in 2 weeks.",
  ...
  },
  {
    ...
    ctaSection: {
      ...
      subtitle: "Talk direct to a senior AI architect in 2 hours — not a salesperson. Working prototype in 2 weeks. Production agent in 8 weeks. Evals and observability included.",
  ...
  },
  {
    ...
    ctaSection: { headline: "Talk to a Healthcare AI Expert — NDA Signed Before We Start", subtitle: "Tell us your biggest challenge — no-shows, claim denials, documentation overload — and a HIPAA-certified senior engineer will call you in 2 hours with a concrete plan. No sales pitch.", buttonText: "Talk to Healthcare AI Expert" },
  ...
  },
  {
    ...
    hero: { badge: "InsurTech AI · IRDAI-Aware · Production-Ready", h1: "AI That Processes Claims in 90 Seconds — Not 9 Days", subtitle: "Insurance agencies, brokers, and carriers use RDMI's AI to automate claims intake, underwrite faster, qualify leads before your team picks up, and detect fraud before it costs you. No vendor lock-in. You own the code.", cta1: "Talk to Insurance AI Expert", cta2: "See Insurance AI in Action", trustPoints: ["IRDAI & GDPR-aware architecture", "Integrates with Applied Epic, Hawksoft, AMS360", "68% faster claims processing", "NDA signed before we discuss your data"] },
    ...
    ctaSection: { headline: "Talk to an Insurance AI Expert — Concrete Plan in 48 Hours", subtitle: "Tell us your bottleneck — claims backlog, fraud leakage, agent capacity — and an insurance-domain senior engineer will call you in 2 hours with a concrete plan. No sales pitch.", buttonText: "Talk to Insurance AI Expert" },
  ...
  },
  {
    ...
    ctaSection: { headline: "Your Competitors Are Already Using AI to Steal Your Bookings", subtitle: "Talk direct to a senior travel-tech engineer in 2 hours. Walk away with a clear AI roadmap and integration checklist. No commitment, no sales pitch.", buttonText: "Talk to Travel AI Expert" },
  ...
  },
  {
    ...
    ctaSection: { headline: "Enterprise Software That Passes Security Review", subtitle: "Senior SaaS architect calls you in 2 hours — not a salesperson. SOC 2-ready by default. Full source code ownership, no vendor lock-in.", buttonText: "Talk to SaaS Architect" },
