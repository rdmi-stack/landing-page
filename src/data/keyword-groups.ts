...
export const keywordGroups: KeywordGroup[] = [
  ...
  },
  {
    ...
    theme: { heroGradient: "linear-gradient(135deg, #2563eb, #0891b2, #1d4ed8)", ctaGradient: "linear-gradient(135deg, #2563eb, #0891b2, #1d4ed8)", urgencyColor: "#2563eb", accent: "blue", icon: "📱" },
    meta: {
