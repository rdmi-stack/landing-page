...
export const keywordGroups: KeywordGroup[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: "₹50K", label: "Starting Price — Not ₹5L" },
      { value: "2-4 Wks", label: "AI-Powered Delivery (vs 8-12 traditional)" },
    ],
    services: [
      { title: "AI-Powered Business Website — ₹50K–₹1.5L", description: "Not a template. A custom-designed, mobile-first website with AI chatbot for lead capture, built-in SEO, contact forms, WhatsApp integration, and Google Analytics. 90+ Lighthouse score guaranteed. Live in 2-3 weeks.", tags: ["Next.js", "Tailwind", "AI Chatbot", "SEO", "WhatsApp"] },
      { title: "Custom Web Application — ₹1.5L–₹5L", description: "Dashboards, portals, booking systems, CRMs — full-stack web apps with user auth, database, APIs, and admin panel. AI features built-in: smart search, auto-reports, recommendations. 4-8 week delivery.", tags: ["React", "Node.js", "MongoDB", "Auth", "Admin Panel"] },
      { title: "E-Commerce Website — ₹75K–₹3L", description: "Shopify, WooCommerce, or custom headless commerce. Product catalog, payments (Razorpay/Stripe), inventory, order tracking. AI recommendations that increase AOV 35%. Live in 3-4 weeks.", tags: ["Shopify", "WooCommerce", "Razorpay", "Headless", "AI Recs"] },
      { title: "WordPress / CMS Website — ₹50K–₹1.5L", description: "High-performance WordPress with custom theme, Gutenberg blocks, WooCommerce, or headless setup. Core Web Vitals 90+. SEO-optimized from day one. 2-3 week delivery.", tags: ["WordPress", "Custom Theme", "ACF", "SEO", "WooCommerce"] },
      { title: "Landing Pages & Microsites — ₹25K–₹75K", description: "High-converting landing pages for Google Ads, campaigns, product launches. A/B test ready, GA4 tracking, conversion-optimized copy. 1-2 week delivery. 4x higher conversion than template builders.", tags: ["Next.js", "Tailwind", "GA4", "A/B Testing", "CRO"] },
      { title: "Website Redesign & Speed Optimization — ₹50K–₹2L", description: "Your existing website is slow, ugly, or not converting? We rebuild it on modern stack (Next.js/React) with 90+ Lighthouse score, mobile-first design, and AI-powered features. Zero downtime migration.", tags: ["Migration", "Speed Optimization", "Lighthouse 90+", "Mobile-First"] },
    ],
    uspHeadlines: {
    ...
    faq: [
      { q: "How much does a custom website cost?", a: "Business website: ₹50K–₹1.5L. Web application: ₹1.5L–₹5L. E-commerce: ₹75K–₹3L. Landing pages: ₹25K–₹75K. Fixed-price quote within 2 hours. The quote IS the final bill." },
    ...
    ctaSection: {
      headline: "Your ₹50K Website Will Look Like a ₹5L Website. Guaranteed.",
      subtitle: "AI-powered custom website with built-in chatbot, SEO, and analytics. Free prototype in 48 hours. Don't love it? Walk away. Senior developer calls you in 2 hours — not a sales rep.",
