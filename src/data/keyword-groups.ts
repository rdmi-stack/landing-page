...
export const keywordGroups: KeywordGroup[] = [
  ...
  },
  {
    ...
    form: { title: "Get Free SEO + AI-Search Audit", subtitle: "Senior SEO strategist delivers gap report in 48 hours", projectTypes: ["Full SEO Strategy", "GEO / AI Search Optimization", "Technical SEO Audit", "Content Strategy", "Link Building & Digital PR", "Local / Programmatic SEO", "Other"], placeholder: "Which keywords or AI models (ChatGPT, Perplexity, Gemini) are you trying to rank on?", buttonText: "Get Free 48hr Audit", formType: "seo-geo" },
    meta: {
      title: "SEO Services for AI Search & Google | GEO Optimization | RDMI",
      description: "SEO services built for AI search — rank on Google, ChatGPT, Perplexity, Claude, and Gemini. GEO (Generative Engine Optimization), technical SEO, content, and link building. ROI-based engagements. Monthly transparency reports.",
    },
    hero: {
      badge: "🔍 SEO for Google AND ChatGPT, Perplexity, Gemini",
      h1: "SEO Services Built for AI Search — Rank on Google, ChatGPT, Perplexity & Gemini",
      subtitle: "Traditional SEO is half the game. AI search now drives 30%+ of high-intent traffic. We rank you on Google AND optimize your content so ChatGPT, Perplexity, Claude, and Gemini cite your brand. ROI-based engagements, monthly transparency reports, walk away anytime.",
      cta1: "Get Free 48hr Audit",
      cta2: "See Our GEO Playbook",
      trustPoints: [
        "AI-search optimized (GEO + AEO)",
        "Google + LLM visibility in one strategy",
        "ROI-based engagement, walk away any month",
        "Monthly transparency report — real data, not vanity metrics",
      ],
    },
    images: {
    ...
    process: [
      { step: "01", title: "Free Audit + AI-Search Gap Analysis", description: "We run your domain through our AI-search visibility scanner (Google + ChatGPT + Perplexity + Gemini) and deliver a prioritized gap report within 48 hours." },
    ...
    ctaSection: { headline: "AI Search Is Quietly Stealing Your Traffic. Win It Back.", subtitle: "Free AI-search + Google SEO audit in 48 hours. Senior strategist delivers the gap report and ROI forecast. Walk away any month if we miss KPIs.", buttonText: "Get Free 48hr Audit" },
  ...
  },
  {
    ...
    form: { title: "Get Free Performance Marketing Audit", subtitle: "Senior marketer audits your accounts + delivers ROI forecast in 48 hours", projectTypes: ["Google Ads Management", "Meta & Instagram Ads", "LinkedIn Ads (B2B)", "Full-Funnel (Paid + SEO + Email)", "SEO + GEO Organic Growth", "CRO & Landing Page Optimization", "Other"], placeholder: "Which channels are you running and what's your current CPA / ROAS?", buttonText: "Get Free ROI Forecast", formType: "digital-marketing-performance" },
    meta: {
      title: "Performance Digital Marketing Agency | AI-Powered Google, Meta & LinkedIn Ads | RDMI",
      description: "AI-powered performance marketing measured in revenue, not impressions. Google Ads, Meta, LinkedIn, SEO, and email — unified around ROAS. Monthly transparency reports, walk away any month.",
    },
    hero: {
      badge: "📈 Performance Marketing — Measured in Revenue, Not Impressions",
      h1: "AI-Powered Digital Marketing That's Measured in Revenue — Not Impressions",
      subtitle: "Google Ads, Meta Ads, LinkedIn Ads, SEO, and email — all unified around one metric: revenue per rupee spent. AI-powered bid optimization, automated creative testing, multi-touch attribution. Monthly ROI reports. Walk away any month.",
      cta1: "Get Free ROI Forecast",
      cta2: "See Our Performance Playbook",
      trustPoints: [
        "ROI-first engagement — clear CPA & ROAS targets",
        "AI-optimized bidding and creative rotation",
        "Monthly transparency report with full attribution",
        "Walk away any month — no long lock-ins",
      ],
    },
    images: {
      hero: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=80",
    ...
    process: [
      { step: "01", title: "Free Account Audit + ROI Forecast", description: "Senior performance marketer audits your Google Ads, Meta, and LinkedIn accounts. Delivers a realistic CPA, ROAS, and revenue forecast for the next 90 days before any commitment." },
    ...
    ctaSection: { headline: "Stop Paying for Impressions. Pay for Revenue.", subtitle: "Free account audit + ROI forecast in 48 hours. Senior performance marketer delivers the report. Walk away any month if we miss KPIs. Month-to-month engagement.", buttonText: "Get Free ROI Forecast" },
