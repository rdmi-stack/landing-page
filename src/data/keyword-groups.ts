...
export const keywordGroups: KeywordGroup[] = [
  ...
  },
  {
    ...
    uspHeadlines: {
      ...
      ai: "OpenAI models, Core ML, TensorFlow Lite, and Whisper in every build — not a chatbot widget in the settings screen. AI sits in the primary user flow, not a hidden sub-menu nobody finds.",
