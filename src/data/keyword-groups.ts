...
export const keywordGroups: KeywordGroup[] = [
  {
    ...
    hero: {
      badge: "Your Competitor Shipped. You're Still Approving the Scope Doc.",
      h1: "Your Competitors Ship Software in 6 Weeks. You're Still Writing the RFP.",
      subtitle: "Legacy agencies staff juniors, bill hourly, and type every line by hand. We ship AI-native software — Cursor, Claude Code, GPT-4o, Claude 3.5 baked into the stack from sprint one. 200+ products live. Senior engineers only. No handoff tax.",
    ...
    stats: [
      ...
      { value: "3x", label: "Faster Delivery vs Traditional Agencies" },
      { value: "40%", label: "Code Written by AI, 100% Reviewed by Seniors" },
      { value: "6 wks", label: "Average MVP to Live URL" },
    ],
    services: [
      { title: "Custom Web Apps That Scale to 10K Concurrent Users", description: "React, Next.js, Node.js on AWS with AI copilots inside the product from sprint one — smart search, auto-summaries, anomaly alerts. Not a static CRUD dashboard your users abandon after week two.", tags: ["Next.js", "Node.js", "PostgreSQL", "GPT-4o"] },
      ...
      { title: "AI-Powered Software — LLM, RAG, Agents", description: "GPT-4o, Claude 3.5, Gemini orchestrated with LangChain and LangGraph. RAG on your docs, autonomous agents on your workflows, LangSmith evals on every deployment. Production AI — not another POC.", tags: ["LangChain", "LangGraph", "Pinecone", "LangSmith"] },
    ...
    uspHeadlines: {
      ...
      ai: "Cursor, Claude Code, GPT-4o, and Claude 3.5 inside every repo from sprint one. AI writes boilerplate, seniors own architecture and review every PR. That's how output per engineer is 3x a legacy shop.",
    ...
    faq: [
      { q: "How is AI-native development different from a traditional agency?", a: "Traditional agencies bill by the hour and type every line by hand. We pair senior engineers with Cursor, Claude Code, and GPT-4o inside the repo. AI writes the boilerplate, humans own architecture and review every PR. You ship working software in weeks instead of quarters, and the engineer who scoped it is the engineer who built it." },
      ...
      { q: "Can you deploy on-prem or in our VPC for regulated data?", a: "Yes. AWS, GCP, Azure, and on-prem Kubernetes. Private LLMs with Llama 3 or Mistral in your VPC when healthcare, BFSI, or legal compliance demands it. Same LangChain code runs on OpenAI or vLLM — no rewrite on migration." },
    ],
    testimonials: [
    ...
    ctaSection: {
      ...
      subtitle: "Senior engineer on the call in 2 hours. Scope and timeline the same day. Working prototype in 48 hours. 200+ products already live.",
  ...
  },
  {
    ...
    hero: {
      badge: "Every New App Ships With AI in the Core. Yours Still Doesn't.",
      h1: "Every New App Has AI in the Core. Yours Still Doesn't.",
      subtitle: "The apps eating your users' attention have voice commands, visual search, AI copilots, and on-device ML. Yours has a hamburger menu. Flutter, Swift, Kotlin with GPT-4o, Core ML, and TensorFlow Lite — built in from sprint one, not retrofitted in v2.",
    ...
    process: [
      ...
      { step: "02", title: "Clickable Prototype in 48 Hours", description: "Real user flows on your phone — not a Figma board. AI features mocked with live GPT-4o responses so you test the experience before committing to a build. Walk away at zero cost if it misses." },
    ...
    services: [
      { title: "Flutter Apps With AI Copilots in the Core", description: "Single codebase for iOS and Android with GPT-4o, voice commands, and smart recommendations baked in from sprint one. Not a hamburger menu over a REST API — an app that learns, predicts, and converts on every session.", tags: ["Flutter", "GPT-4o", "Firebase", "LangChain"] },
      ...
      { title: "Voice and Conversational Mobile Apps", description: "Users talk to your app instead of tapping through five screens. Whisper on-device for transcription, GPT-4o for reasoning, eleven-voice TTS for natural responses. WhatsApp and Twilio integrations for hybrid UX.", tags: ["Whisper", "GPT-4o", "WhatsApp API", "Twilio"] },
    ...
    uspHeadlines: {
      direct: "Senior mobile engineer calls you in 2 hours — not a sales rep with a Flutter brochure. The engineer who scopes your app is the engineer who ships it and answers your Slack on day one-hundred.",
      ai: "GPT-4o, Core ML, TensorFlow Lite, and Whisper in every build — not a chatbot widget in the settings screen. AI sits in the primary user flow, not a hidden sub-menu nobody finds.",
      cost: "Full source code, AI prompts, and model weights yours from day one. On-device ML means no per-query inference bills forever. No proprietary SDK lock-in. Take the app to any team.",
    },
    faq: [
    ...
    ctaSection: {
      headline: "Your Competitors Ship Apps With AI. You Still Ship Menus.",
      subtitle: "Senior mobile engineer calls you in 2 hours. Clickable prototype in 48. First TestFlight build in 14 days. AI in the core from sprint one.",
  ...
  },
  {
    ...
    meta: {
      ...
      description: "Your static brochure is losing to your competitor's AI-powered salesperson. Next.js sites with GPT-4o copilots, GEO schema for ChatGPT citation, sub-1s TTFB. 200+ sites live.",
    },
    hero: {
      badge: "30%+ of Buyers Now Start Research in ChatGPT and Perplexity.",
      h1: "Your Website Is Still a Static Brochure. Your Competitors' Is a Salesperson.",
      subtitle: "While your site hands visitors a hamburger menu, your competitor's GPT-4o copilot answers product questions, books demos, and qualifies leads 24/7 — and ranks in ChatGPT, Perplexity, and Gemini answers. Next.js, AI copilots, GEO schema, sub-1s TTFB. Senior engineers only.",
      cta1: "Talk to Web Developer",
      cta2: "See Websites We've Built",
      trustPoints: ["GPT-4o copilot in every site — not a chat widget", "GEO schema so ChatGPT and Perplexity cite you", "Sub-1s TTFB on Vercel Edge — not a WordPress host", "Senior engineer on standups — no account manager"],
    },
    images: {
    ...
    process: [
      ...
      { step: "02", title: "Clickable Prototype in 48 Hours", description: "Real flows on your real brand — not a generic Figma template. AI copilot and lead-capture mocked with live GPT-4o responses. Walk away at zero cost if it misses." },
    ...
    services: [
      { title: "AI Website With GPT-4o Copilot and GEO Schema", description: "A site that answers product questions, books demos, and qualifies leads 24/7 — grounded in your real content with forced citations. Ranks in Google AND gets cited by ChatGPT, Perplexity, and Gemini.", tags: ["Next.js", "GPT-4o", "llms.txt", "Schema.org"] },
    ...
    uspHeadlines: {
      ...
      ai: "GPT-4o copilot, GEO schema, AI-written meta tags, and llms.txt in every build from sprint one. Your site answers questions, books meetings, and gets cited by ChatGPT — not a static page that dies after launch.",
    ...
    faq: [
      ...
      { q: "What happens when GPT-5, Claude 4, or Gemini 3 ships?", a: "Model-agnostic architecture with provider abstractions and eval suites. New model ships, we re-run evals — swap if it scores better, roll back if it regresses. Same code runs across GPT-4o, Claude 3.5, Gemini, and local Llama. You're not locked to one vendor's release cycle." },
      { q: "Will my content and prompts train someone else's AI model?", a: "No. Your content, embeddings, prompts, and chat logs stay in your infrastructure. No clause letting us reuse your data. Optional private deploy on OpenAI Enterprise or Llama 3 in your VPC for regulated content. NDA signed before first call." },
    ...
    ctaSection: {
      ...
      subtitle: "Senior web engineer calls you in 2 hours. Clickable prototype in 48. Live staging URL in 14 days. GPT-4o copilot and GEO schema in every build.",
  ...
  },
  {
    ...
    meta: {
      title: "AI Software Development | GPT-4o, Claude, LangChain — Shipped in 8 Weeks | RDMI",
      description: "76% of enterprises buy AI, they don't build it (Menlo 2025). Production AI in 8 weeks. GPT-4o, Claude 3.5, LangChain, Pinecone, LangSmith. Evals and observability from day one.",
    },
    hero: {
      badge: "76% of Enterprises Buy AI — They Don't Build It (Menlo 2025)",
      h1: "Your Competitor Shipped AI Software Last Quarter. You're Still Writing the POC Deck.",
      subtitle: "Production AI — not another failed pilot. GPT-4o, Claude 3.5, Gemini, LangChain, Pinecone, LangSmith. Evals, observability, and guardrails baked in from day one. Prototype in 2 weeks. Production in 8. Senior AI engineers only.",
    ...
    services: [
      ...
      { title: "AI-Powered SaaS + Copilots", description: "Embed smart search, auto-summarisation, anomaly detection, and conversational workflows into your product. Vercel AI SDK, streaming UI, multi-model routing between GPT-4o, Claude, and Gemini.", tags: ["Vercel AI SDK", "GPT-4o", "Claude 3.5", "Gemini"] },
      ...
      { title: "Private / On-Prem LLM Deployments", description: "Llama 3, Mistral, or your fine-tuned model in your VPC. Same orchestration code runs on OpenAI or vLLM — no rewrite. Required for healthcare, BFSI, legal, and regulated data.", tags: ["Llama 3", "Mistral", "vLLM", "VPC Deploy"] },
    ],
    uspHeadlines: {
    ...
    faq: [
      ...
      { q: "What happens when the underlying LLM (GPT-5, Claude 4) ships and breaks my system?", a: "We design model-agnostic. Every deployment has an eval suite — when a new model ships we re-run evals, swap if it scores better, roll back if it regresses. You're not coupled to one vendor's release cycle. Same code runs across GPT-4o, Claude 3.5, Gemini, and Llama 3." },
      ...
      { q: "Do you offer on-prem or private LLM for regulated data?", a: "Yes. Llama 3, Mistral, or your own fine-tuned model hosted in your VPC on AWS, GCP, Azure, or bare metal. Routine for healthcare, BFSI, legal, and defence. Same LangChain / LangGraph code runs on OpenAI or vLLM — no rewrite, no vendor switch." },
    ],
    ctaSection: {
  ...
  },
  {
    ...
    hero: {
      badge: "30%+ of Buyers Now Start Shopping in AI Search — Not Google",
      h1: "Your Shopify Store Isn't Losing to Amazon. It's Losing to ChatGPT.",
      subtitle: "Every e-commerce store built in 2026 has AI in search, recommendations, and checkout. Yours probably doesn't. Shopify Plus, headless Next.js, grocery delivery apps, and B2B marketplaces — engineered for AI-era discovery, conversion, and repeat revenue.",
  ...
  },
  {
    ...
    meta: {
      title: "AI Agent Development Company | LangGraph, CrewAI, GPT-4o — Shipped in 8 Weeks | RDMI",
    ...
    hero: {
      badge: "Only 21% of Enterprises Have Agent Governance (Deloitte 2025)",
      h1: "Your Competitors Ship AI Agents in 8 Weeks. You're Still Debating Whether to Build or Buy.",
      subtitle: "Multi-step reasoning, tool use, memory, and human-in-the-loop — built on GPT-4o, Claude 3.5, and Llama 3. Production-grade from sprint one with LangSmith evals, typed tool schemas, and guardrails. Not another demo that dies in QA.",
    ...
    services: [
      ...
      { title: "On-Prem / Private LLM Agents", description: "Agents running on Llama 3, Mistral, or your fine-tuned model in your VPC. Required for healthcare, BFSI, legal, defence. Same LangGraph orchestration code runs on OpenAI or vLLM — no rewrite.", tags: ["Llama 3", "Mistral", "vLLM", "VPC Deploy"] },
    ],
    uspHeadlines: {
    ...
    faq: [
      ...
      { q: "On-prem or private LLM for regulated data?", a: "Yes. Llama 3, Mistral, or your fine-tuned model hosted in your VPC on AWS, GCP, Azure, or bare metal. Routine for healthcare, BFSI, legal, defence. Same LangGraph / CrewAI code runs on OpenAI or vLLM — no rewrite, no vendor switch." },
    ],
    testimonials: [
  ...
  },
  {
    ...
    hero: {
      badge: "DFSA 2025 — 52% of DIFC Firms Are Live With AI. Up From 33% a Year Ago.",
      h1: "DIFC Firms Are Deploying AI in 8 Weeks. Your Ops Team Is Still in Diligence.",
      subtitle: "22 Chief AI Officers now sit inside Dubai government. 500+ companies operate from Dubai AI Campus. Most UAE mid-market firms are still writing RFPs. RDMI ships production Arabic-first AI agents, RAG systems, and autonomous workflows in 8-10 weeks — DIFC-compliant, hosted inside the UAE, senior engineers only.",
  ...
  },
  {
    ...
    hero: {
      badge: "McKinsey 2025 — 88% of US Tech Orgs Use GenAI. Coding AI Alone = $4B (Menlo).",
      h1: "San Francisco Quoted You $80K and 20 Weeks. We Ship the Same Agent in 8.",
      subtitle: "US agencies bill $100-$300 an hour for AI engineers you never meet. RDMI puts the senior engineer writing your code on the kickoff call — 4-8 hour EST/PST overlap, SOC 2-ready architecture, HIPAA-grade controls, and 100% IP transfer before the first commit. NYC, SF, Seattle, Austin and Boston teams are already live.",
      cta1: "Talk to AI Expert",
  ...
  },
  {
    ...
    hero: { badge: "Menlo 2025 — $1.5B US Healthcare AI Spend. Ambient Scribes Alone Are a $600M Category.", h1: "ChatGPT Can't Touch PHI. Your AI Vendor Probably Shouldn't Either.", subtitle: "Every free LLM wrapper in your inbox is a HIPAA breach waiting to happen. RDMI ships ambient scribes, AI schedulers, RCM agents, and clinical chatbots with a signed BAA before the first technical call — AES-256 encrypted, PHI-isolated, and deployed on HIPAA-eligible cloud. Dental, primary care, specialty, multi-site — scoped in writing.", cta1: "Talk to Healthcare AI Expert", cta2: "See How It Works", trustPoints: ["BAA signed before PHI — not after", "40% no-show reduction typical within 60 days", "92%+ first-pass claim acceptance with RCM AI", "3-6 hours reclaimed per clinician per day"] },
  ...
  },
  {
    ...
    hero: { badge: "9 Days vs 90 Seconds — the Gap Widens Every Quarter a Carrier Waits.", h1: "Claims Clerks Cost $50K/Year. AI Agents Do 90% of Their Work — Correctly.", subtitle: "First Notice of Loss still takes an adjuster 9 days. AI-assisted intake takes 90 seconds and gets the same answer. RDMI ships explainable claims, underwriting, fraud, and voice agents for carriers, MGAs and independent agencies — IRDAI + NAIC-aware, plugged into Applied Epic, AMS360, Hawksoft and Guidewire, with 100% code and model ownership transferred at go-live.", cta1: "Talk to Insurance AI Expert", cta2: "See Insurance AI in Action", trustPoints: ["IRDAI + NAIC + GDPR + DPDP-aware architecture", "Integrates with Applied Epic, AMS360, Hawksoft, Guidewire", "Explainable risk scores — every decision auditable", "NDA signed before any loss-run data is shared"] },
  ...
  },
  {
    ...
    hero: { badge: "OTAs Still Skim 10-25% of Every Room Night. AI Concierges Are Taking It Back.", h1: "Hotels Lose 28% of Direct Bookings to OTAs. AI Concierges Win Them Back.", subtitle: "Booking.com keeps 15-20% of every reservation. Expedia keeps 20-25%. Meanwhile guests are already chatting with AI everywhere else. RDMI ships Opera / Cloudbeds / Mews-integrated AI booking agents, 12+ language concierges, and dynamic revenue engines that capture direct demand, lift RevPAR, and cut front-desk load — live in 4-8 weeks, fixed-scope, scoped before any code.", cta1: "Talk to Travel AI Expert", cta2: "See Live Demo", trustPoints: ["Opera, Cloudbeds, Mews, Booking.com, Expedia integrated", "12+ languages with mid-conversation switching", "Dynamic RMS re-prices every 15 minutes across OTAs", "Fixed-scope, milestone-based delivery — zero scope creep"] },
  ...
  },
  {
    ...
    hero: {
      badge: "88% of Enterprises Are Piloting AI Agents. Only 21% Have Governance (Deloitte).",
      h1: "Every New Enterprise SaaS Has AI in the Core. Your 2020 Stack Is Getting Replaced.",
      subtitle: "Your competitors ship SaaS with AI copilots, agent-driven workflows, and RAG search baked in — and pass SOC 2 on first audit. Your stack still makes users click through 12 screens. Multi-tenant, SSO/SCIM, audit logs, LangGraph agents — engineered from sprint one, not retrofitted in v3.",
    ...
    services: [
      { title: "Multi-Tenant SaaS With AI Copilot in the Product", description: "Row-level tenant isolation, Stripe billing, feature flags, usage metering — and a GPT-4o or Claude 3.5 copilot inside the product that draft-writes, summarises, and automates workflows for every tenant. Scales from first customer to ten thousand without rewrite.", tags: ["PostgreSQL RLS", "Stripe", "GPT-4o", "Vercel AI SDK"] },
      ...
      { title: "Sales and Service CRM With AI Copilots", description: "Pipeline, contacts, ticketing, forecasting with GPT-4o copilots that summarise calls, draft follow-ups, qualify leads, and deflect tier-one tickets. Native WhatsApp, email, and voice integrations. No Salesforce tax, full source code ownership.", tags: ["Pipeline", "GPT-4o", "WhatsApp API", "Twilio"] },
    ...
    uspHeadlines: {
      ...
      ai: "LangGraph agents, LangSmith evals, and GPT-4o copilots inside the product from sprint one. Human-in-the-loop gates, forced citations, and eval thresholds in the contract. Production AI — not a POC that rots in QA.",
      cost: "Full source code, AI prompts, eval sets, and model weights yours on day one. No per-seat SaaS markup forever. No vendor lock-in. Run on OpenAI today, swap to private Llama 3 in your VPC tomorrow — same codebase.",
    },
    faq: [
      ...
      { q: "Will our prompts, embeddings, and customer data train someone else's model?", a: "No. Your content, embeddings, prompts, fine-tuned weights, and chat logs stay in your infrastructure. No clause letting us reuse your data for other clients. Private deploy available on OpenAI Enterprise, Azure OpenAI, or Llama 3 in your VPC for regulated industries." },
      { q: "What happens when GPT-5 or Claude 4 ships and changes our agent behaviour?", a: "We build model-agnostic with provider abstractions and LangSmith eval suites. New model ships, we re-run evals — swap if it scores better, roll back if it regresses. Same code runs across GPT-4o, Claude 3.5, Gemini, and on-prem Llama 3. Model upgrades are a planned release, not a fire drill." },
    ...
    testimonials: [
      { quote: "14 weeks to multi-tenant SaaS with SSO, SCIM, audit logs, and a GPT-4o copilot inside the product. Previous vendor quoted 40 weeks for a stack without any AI. Enterprise customers signed without a security escalation — the AI copilot closed the last two deals on its own.", author: "J.K.", role: "CTO, B2B SaaS (USA)", rating: 5 },
  ...
  },
  {
    ...
    hero: {
      badge: "AI-Native Senior Engineers — Not 2018 Outsourcing Resumes",
      h1: "Legacy Outsourcing Shops Are Still Selling You Juniors With ChatGPT. We're Done With That.",
      subtitle: "Top 3% senior engineers who ship production code with Cursor, Claude Code, and Copilot every day — not trainees learning on your project. 7-day SLA from brief to kickoff. 48-hour replacement. Direct Slack, direct standups, direct output.",
  ...
  },
  {
    ...
    hero: {
      badge: "30%+ of Buyers Now Start in ChatGPT — Not Google",
      h1: "Your Support Team Drowns in Password Resets. Your Chatbot Still Says 'I Didn't Catch That'.",
      subtitle: "Template bots hallucinate and frustrate. Grounded RAG chatbots deflect 60% of tickets with citations, escalate with full context, and speak 30+ languages. Live on your site or WhatsApp in 14 days — with an eval suite in the contract.",
    ...
    faq: [
      ...
      { q: "What happens if the underlying LLM (GPT-5, Claude 4) ships and breaks my bot?", a: "Model-agnostic by design. Every chatbot has an eval suite — when a new model ships we re-run it, swap if it scores better, roll back if it regresses. Same code runs across GPT-4o, Claude 3.5, Gemini, Llama 3. No rewrite, no vendor lock-in." },
      ...
      { q: "On-prem or private LLM for regulated data (HIPAA, DPDP, GDPR)?", a: "Yes. Llama 3 or Mistral in your VPC, PII redaction before any LLM call, configurable retention, audit logs. GDPR, HIPAA, and DPDP Act-aligned deployments available. Same orchestration code — no rewrite." },
    ],
    testimonials: [
  ...
  },
  {
    ...
    hero: {
      badge: "74% Plan Agentic Automation in 2 Years. Only 21% Are Ready (Deloitte 2025)",
      h1: "Your Ops Team Copies Data Between 7 Tools All Day. Your Competitor Automated That Workflow in Week One.",
      subtitle: "Document processing, email triage, reconciliation, onboarding — automated end-to-end with AI in the loop and humans approving what matters. n8n, Temporal, LangChain orchestration. 100+ production workflows shipped. 6-week ROI payback on most deployments.",
