...
const landingPages: LandingPageData[] = [
  ...
  { name: "FAQ", route: "/faq", type: "sitelink", hasNavbar: true, status: "live" },
  {
    ...
    route: "/ecommerce-development-company",
    type: "keyword",
    hasNavbar: false,
    status: "live",
    keywords: ["ecommerce development company India", "Shopify development company", "grocery delivery app development company", "marketplace development company", "ecommerce website development company"],
  },
  {
    ...
    hasNavbar: false,
    status: "live",
    keywords: ["mobile app development company India", "app development company India", "Flutter app development company", "iOS app development company", "AI app development company"],
  },
  {
    name: "Custom Software Development Company",
    route: "/custom-software-development-company",
    type: "keyword",
    hasNavbar: false,
    status: "live",
    keywords: ["custom software development company India", "custom software development services", "SaaS development company India", "business software development", "AI-powered software development"],
  },
  {
    name: "AI-First Web Design & Software Agency",
    route: "/web-development-company",
    type: "keyword",
    hasNavbar: false,
    status: "live",
    keywords: ["web design company India", "web development agency India", "AI-first web development", "custom web development India"],
  },
  {
    name: "Enterprise Software Development Company",
    route: "/enterprise-software-development-company",
    type: "keyword",
    hasNavbar: false,
    status: "live",
    keywords: ["enterprise software development company India", "ERP development company India", "CRM development company India", "custom enterprise software development", "business process automation software"],
  },
  {
    name: "AI Software Development Company",
    route: "/ai-software-development-company",
    type: "keyword",
    hasNavbar: false,
    status: "live",
    keywords: ["AI software development company India", "AI agent development company", "RAG development company", "AI chatbot development company", "AI automation company"],
  },
  {
    name: "AI Agent Development Company",
    route: "/ai-agent-development-company",
    type: "keyword",
    hasNavbar: false,
    status: "live",
    keywords: ["AI agent development company", "custom AI agent development", "LangGraph development", "CrewAI development", "voice AI agent development"],
  },
];
