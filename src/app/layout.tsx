...
export const metadata: Metadata = {
  title: "RDMI AI Services | Custom Software & App Development Company India | Save 50% Cost",
  description:
    "RDMI AI Services - India's AI-first custom software development company. Talk to developers directly, save 50% on software development costs. Expert web app, mobile app, SaaS & enterprise software development services.",
  keywords:
  ...
  openGraph: {
    title: "RDMI AI Services | Custom Software & App Development India",
    description:
